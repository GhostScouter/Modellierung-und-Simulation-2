 ...
 : public ILinearSolver<TMatrix>
{
	...
	private:
		corrector_type* m_corrector;	// legt Preconditioner und? matrix_type fest

		std::size_t m_nit;				// Abbruch nach Zeit
		double m_minDef;				// Abbruch nach keiner Verbesserung
		double m_minRed;				// Abbruch nachzu kleiner Verbesserung
